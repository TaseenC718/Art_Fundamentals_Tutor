...
const CameraController = ({ 
  ...
  useEffect(() => {
    if (preset === '1pt' || preset === '2pt') {
      ...
      camera.position.set(0, 0, EYE_Z_INITIAL);
        ...
        <div className="flex-1 w-full relative">
          <Canvas gl={{ preserveDrawingBuffer: true }}>
            <Suspense fallback={null}>
              <CameraController fov={fov} preset={preset} />
              <SceneContent 
                ...
                {(preset === '1pt' || preset === '2pt') && (
                    <div className="pl-4">
                        <button
                            ...
                            className={`text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-md border transition-colors ${
                                showGuides 
